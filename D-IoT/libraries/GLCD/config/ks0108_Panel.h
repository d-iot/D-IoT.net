...
*/
#if glcd_CHIP_COUNT == 2 //burada degisiklik
...
//#if defined(winstar)
	#include "config/ks0108_Mega_Winstar.h"      // config for mega 1280/2560 board
//#else
	//#include "config/ks0108_Mega_Sunman.h"      // config for mega 1280/2560 board
