...
//                          //MEGA  LCDINFO		LCDPIN
//						--	  --	--------	------
#define glcdCSEL1       59  //31	CS1 Bit		01
#define glcdCSEL2       58  //32	CS2 Bit		02
							//--	GND			03			GND
							//--	+5			04			5V
							//--	V0/NC		05			POD ORTA
#define glcdDI          57  //33	RS-DI		06
#define glcdRW          56  //34	R/W Bit		07
#define glcdEN          55  //35	EN Bit		08
#define glcdData0Pin    54	//36	D0			09  
#define glcdData1Pin    53	//37	D1			10
#define glcdData2Pin    50	//38	D2			11
#define glcdData3Pin    70	//39	D3			12
#define glcdData4Pin    52	//40	D4			13
#define glcdData5Pin    51	//41	D5			14
#define glcdData6Pin    42	//42	D6			15
#define glcdData7Pin    41	//43	D7			16
							//--	RST			17  
							//--	VEE			18			PODSOL
							//--	A+			19			3.3V
							//--	A-			20			GND
